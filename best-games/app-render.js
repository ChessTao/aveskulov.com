(() => {
  function createRenderer(options) {
    ...
    function updateStatus(chess) {
      ...
      const isWhiteAtBottom = state.orientation === 'white';
      whiteTurnDotEl.classList.toggle('active', isWhiteTurn);
      blackTurnDotEl.classList.toggle('active', !isWhiteTurn);
      whiteTurnDotEl.classList.toggle('bottom', isWhiteAtBottom);
      whiteTurnDotEl.classList.toggle('top', !isWhiteAtBottom);
      blackTurnDotEl.classList.toggle('top', isWhiteAtBottom);
      blackTurnDotEl.classList.toggle('bottom', !isWhiteAtBottom);
    }
